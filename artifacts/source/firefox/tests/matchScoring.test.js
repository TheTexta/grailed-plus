...
test("scoreCandidate strips boilerplate and hash-like tokens from the image heuristic", () => {
  const listing = {
    title: "Stone Island Jacket",
    imageUrl: "https://cdn.example.com/images/upload/v123/stone-island-jacket-front_1200x1200.jpg",
    rawListing: {}
  };
  ...
  const candidate = {
    id: "img-heuristic-1",
    title: "Stone Island Jacket",
    url: "https://depop.test/item/img-heuristic-1",
    imageUrl:
      "https://media.depop.test/products/7f3a9c2d1e0f4ab8/preview/stone-island-jacket-front.webp?quality=80",
    price: 200,
    currency: "USD"
  };
...
test("scoreCandidate does not mark usedImage when URLs have no usable heuristic stem", () => {
  const listing = {
    title: "Stone Island Jacket",
    imageUrl: "https://cdn.example.com/images/7f3a9c2d1e0f4ab8cdef9012.jpg?width=600",
    rawListing: {}
  };
  ...
  const candidate = {
    id: "img-heuristic-2",
    title: "Stone Island Jacket",
    url: "https://depop.test/item/img-heuristic-2",
    imageUrl: "https://media.depop.test/products/f0e1d2c3b4a5968776655443.png?quality=80",
    price: 200,
    currency: "USD"
  };
...
test("rankCandidates uses price delta in balanced mode when search-result metadata is sparse", () => {
  const listing = {
    title: "Vintage Bomber Jacket",
    pricing: {
      history: [200]
  ...
  const candidates = [
    {
      id: "close-price",
      title: "Vintage Bomber Jacket",
      url: "https://depop.test/item/close-price",
      imageUrl: "",
      price: 205,
      currency: "USD"
    },
    {
      id: "far-price",
      title: "Vintage Bomber Jacket",
      url: "https://depop.test/item/far-price",
      imageUrl: "",
      price: 330,
      currency: "USD"
    }
  ...
  assert.equal(ranked[0].id, "close-price");
  assert.ok(ranked[0].score > ranked[1].score);
  assert.ok((ranked[0].components.priceScore || 0) > (ranked[1].components.priceScore || 0));
});
