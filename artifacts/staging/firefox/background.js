...
(function () {
    ...
    function isValidSearchRequestMessage(message) {
    ...
    function isValidImageRequestMessage(message) {
        if (!isObjectRecord(message)) {
            return false;
        }
    ...
    function resolveImageFetchTimeoutMs() {
    ...
    async function handleImageFetch(message) {
    ...
    function createRuntimeMessageListener() {
        return function (message, sender, sendResponse) {
            ...
            var handler = message.type === IMAGE_MESSAGE_TYPE ? handleImageFetch : handleSearchFetch;
            handler(message)
